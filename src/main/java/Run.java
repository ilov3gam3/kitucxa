...
/*        String start = "2023-05-01";
        ...
        System.out.println("pre : " + Semester.getPreviousSemester());
        String semester = Semester.getPreviousSemester();
        assert semester != null;
        System.out.println(Arrays.toString(new String[]{
                semester.split("-")[0] + "-" + Semester.valueOf(semester.split("-")[1] + "_start").getDetail(),
                semester.split("-")[0] + "-" + Semester.valueOf(semester.split("-")[1] + "_end").getDetail()
        }));
    }
}
